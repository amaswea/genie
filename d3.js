...
! function (t, n) {
    ...
    function Vo(t, n, r, i, o, u, a, c, s) {
        ...
        var h = ko(mo, rr),
            ...
            w = s("%B"),
            M = s("%Y"),
            T = [[a, 1, Vg], [a, 5, 5 * Vg], [a, 15, 15 * Vg], [a, 30, 30 * Vg], [u, 1, Wg], [u, 5, 5 * Wg], [u, 15, 15 * Wg], [u, 30, 30 * Wg], [o, 1, $g], [o, 3, 3 * $g], [o, 6, 6 * $g], [o, 12, 12 * $g], [i, 1, Zg], [i, 2, 2 * Zg], [r, 1, Gg], [n, 1, Jg], [n, 3, 3 * Jg], [t, 1, Qg]];
    ...
    function Ra(t) {
        return "string" == typeof t ? new qa([[document.querySelector(t)]], [document.documentElement]) : new qa([[t]], bm)
    }
    ...
    function Yc(t, n) {
        ...
        if (i) {
            n = null == n ? null : n + "";
            for (r in i)
                if ((e = i[r]).state > km && e.name === n) return new Uc([[t]], Lm, n, (+r))
        }
        return null
    }
    ...
    function Il(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                _ < h && (N *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, k in px && Y.attr("cursor", hx[k = px[k]])), g < d && (A *= -1, t = p, p = y, y = t, t = d, d = g, g = t, k in dx && Y.attr("cursor", hx[k = dx[k]])), z = E.selection, w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (E.selection = [[h, d], [_, g]], r.call(T), F.brush())
            }
            ...
            if (f.apply(this, arguments)) {
                ...
                "overlay" === k ? E.selection = z = [[l = n === fx ? P : D[0], p = n === sx ? q : D[1]], [v = n === fx ? L : l, y = n === sx ? R : p]] : (l = z[0][0], p = z[0][1], v = z[1][0], y = z[1][1]), h = l, d = p, _ = v, g = y;
        ...
        return e.move = function (t, e) {
            ...
            return arguments.length ? (s = "function" == typeof t ? t : Nl([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), e) : s
        }, e.filter = function (t) {
    ...
    function th(t) {
        return t > 1 ? cb : t < -1 ? -cb : Math.asin(t)
    }
    ...
    function rh(t, n) {
        t && Sb.hasOwnProperty(t.type) && Sb[t.type](t, n)
    }
    ...
    function uh(t, n) {
        t && kb.hasOwnProperty(t.type) ? kb[t.type](t, n) : rh(t, n)
    }
    ...
    function sh(t, n) {
        Nb.point = fh, Sx = t, Nx = n, t *= hb, n *= hb, Ax = t, Ex = _b(n = n / 2 + sb), Cx = bb(n)
    }
    ...
    function fh(t, n) {
        ...
        var e = t - Ax,
            ...
            c = Ex * o + a * _b(i),
            s = a * r * bb(i);
        Tx.add(vb(s, c)), Ax = t, Ex = o, Cx = u
    }

    function lh(t) {
        return kx ? kx.reset() : (kx = Gl(), Tx = Gl()), uh(t, Nb), 2 * kx
    }

    function hh(t) {
        return [vb(t[1], t[0]), th(t[2])]
    }
    ...
    function gh(t) {
        var n = Mb(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
        t[0] /= n, t[1] /= n, t[2] /= n
    }

    function mh(t, n) {
        Ix.push(Yx = [zx = t, qx = t]), n < Px && (Px = n), n > Lx && (Lx = n)
    }
    ...
    function xh(t, n) {
        ...
        if (Ox) {
            ...
            var u, a = t - Rx,
                ...
                s = o[0] * lb * c,
                f = pb(a) > 180;
            f ^ (c * Rx < s && s < c * t) ? (u = o[1] * lb, u > Lx && (Lx = u)) : (s = (s + 360) % 360 - 180, f ^ (c * Rx < s && s < c * t) ? (u = -o[1] * lb, u < Px && (Px = u)) : (n < Px && (Px = n), n > Lx && (Lx = n))), f ? t < Rx ? Sh(zx, t) > Sh(zx, qx) && (qx = t) : Sh(t, qx) > Sh(zx, qx) && (zx = t) : qx >= zx ? (t < zx && (zx = t), t > qx && (qx = t)) : t > Rx ? Sh(zx, t) > Sh(zx, qx) && (qx = t) : Sh(t, qx) > Sh(zx, qx) && (zx = t)
        } else mh(t, n);
        Ox = e, Rx = t
    }
    ...
    function wh() {
        Yx[0] = zx, Yx[1] = qx, Ab.point = mh, Ox = null
    }

    function Mh(t, n) {
        if (Ox) {
            var e = t - Rx;
            Fx.add(pb(e) > 180 ? e + (e > 0 ? 360 : -360) : e)
        } else Ux = t, Dx = n;
        Nb.point(t, n), xh(t, n)
    }
    ...
    function kh() {
        Mh(Ux, Dx), Nb.lineEnd(), pb(Fx) > ob && (zx = -(qx = 180)), Yx[0] = zx, Yx[1] = qx, Ox = null
    }
    ...
    function Eh(t) {
        var n, e, r, i, o, u, a;
        if (Fx ? Fx.reset() : Fx = Gl(), Lx = qx = -(zx = Px = 1 / 0), Ix = [], uh(t, Ab), e = Ix.length) {
            for (Ix.sort(Nh), n = 1, r = Ix[0], o = [r]; n < e; ++n) i = Ix[n], Ah(r, i[0]) || Ah(r, i[1]) ? (Sh(r[0], i[1]) > Sh(r[0], r[1]) && (r[1] = i[1]), Sh(i[0], r[1]) > Sh(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n) i = o[n], (a = Sh(r[1], i[0])) > u && (u = a, zx = i[0], qx = r[1])
        }
        return Ix = Yx = null, zx === 1 / 0 || Px === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[zx, Px], [qx, Lx]]
    }

    function Ch(t, n) {
        t *= hb, n *= hb;
        var e = _b(n);
        zh(e * _b(t), e * bb(t), bb(n))
    }

    function zh(t, n, e) {
        ++Bx, Hx += (t - Hx) / Bx, Xx += (n - Xx) / Bx, Vx += (e - Vx) / Bx
    }
    ...
    function qh(t, n) {
        t *= hb, n *= hb;
        var e = _b(n);
        nb = e * _b(t), eb = e * bb(t), rb = bb(n), Eb.point = Lh, zh(nb, eb, rb)
    }
    ...
    function Lh(t, n) {
        ...
        var e = _b(n),
            ...
            i = e * bb(t),
            o = bb(n),
            u = vb(Mb((u = eb * o - rb * i) * u + (u = rb * r - nb * o) * u + (u = nb * i - eb * r) * u), nb * r + eb * i + rb * o);
        jx += u, Wx += u * (nb + (nb = r)), $x += u * (eb + (eb = i)), Zx += u * (rb + (rb = o)), zh(nb, eb, rb)
    }
    ...
    function Dh() {
        Fh(Kx, tb), Eb.point = Ch
    }

    function Oh(t, n) {
        Kx = t, tb = n, t *= hb, n *= hb, Eb.point = Fh;
        var e = _b(n);
        nb = e * _b(t), eb = e * bb(t), rb = bb(n), zh(nb, eb, rb)
    }
    ...
    function Fh(t, n) {
        ...
        var e = _b(n),
            ...
            l = s && -Kl(f) / s,
            h = vb(s, f);
        Gx += l * u, Jx += l * a, Qx += l * c, jx += h, Wx += h * (nb + (nb = r)), $x += h * (eb + (eb = i)), Zx += h * (rb + (rb = o)), zh(nb, eb, rb)
    }

    function Ih(t) {
        Bx = jx = Hx = Xx = Vx = Wx = $x = Zx = Gx = Jx = Qx = 0, uh(t, Eb);
        var n = Gx,
            e = Jx,
            r = Qx,
            i = n * n + e * e + r * r;
        return i < ub && (n = Wx, e = $x, r = Zx, jx < ob && (n = Hx, e = Xx, r = Vx), i = n * n + e * e + r * r, i < ub) ? [NaN, NaN] : [vb(e, n) * lb, th(r / Mb(i)) * lb]
    }
    ...
    function jh(t, n) {
        return [t > ab ? t - fb : t < -ab ? t + fb : t, n]
    }

    function Hh(t, n, e) {
        return (t %= fb) ? n || e ? Bh(Vh(t), Wh(n, e)) : Vh(t) : n || e ? Wh(n, e) : jh
    }

    function Xh(t) {
        return function (n, e) {
            return n += t, [n > ab ? n - fb : n < -ab ? n + fb : n, e]
        }
    }
    ...
    function Wh(t, n) {
        function e(t, n) {
            var e = _b(n),
                ...
                s = bb(n),
                f = s * r + a * i;
            return [vb(c * o - f * u, a * r - s * i), th(f * o + c * u)]
        }
        var r = _b(t),
            i = bb(t),
            o = _b(n),
        ...
        return e.invert = function (t, n) {
            var e = _b(n),
                ...
                s = bb(n),
                f = s * o - c * u;
            return [vb(c * o + s * u, a * r + f * i), th(f * r - a * i)]
        }, e
    }

    function $h(t) {
        function n(n) {
            return n = t(n[0] * hb, n[1] * hb), n[0] *= lb, n[1] *= lb, n
        }
        return t = Hh(t[0] * hb, t[1] * hb, t.length > 2 ? t[2] * hb : 0), n.invert = function (n) {
            return n = t.invert(n[0] * hb, n[1] * hb), n[0] *= lb, n[1] *= lb, n
        }, n
    }
    ...
    function Zh(t, n, e, r, i, o) {
        if (e) {
            var u = _b(n),
                a = bb(n),
                c = r * e;
            null == i ? (i = n + r * fb, o = n - c / 2) : (i = Gh(u, i), o = Gh(u, o), (r > 0 ? i < o : i > o) && (i += r * fb));
            for (var s, f = i; r > 0 ? f > o : f < o; f -= c) s = hh([u, -a * _b(f), -a * bb(f)]), t.point(s[0], s[1])
        }
    }
    ...
    function Gh(t, n) {
        n = ph(n), n[0] -= t, gh(n);
        var e = Kl(-n[1]);
        return ((-n[2] < 0 ? -e : e) + fb - ob) % fb
    }

    function Jh() {
        function t(t, n) {
            e.push(t = r(t, n)), t[0] *= lb, t[1] *= lb
        }

        function n() {
            var t = i.apply(this, arguments),
                n = o.apply(this, arguments) * hb,
                c = u.apply(this, arguments) * hb;
            return e = [], r = Hh(-t[0] * hb, -t[1] * hb, 0).invert, Zh(a, n, c, 1), t = {
                type: "Polygon",
                coordinates: [e]
            }, e = r = null, t
        }
    ...
    function tp(t, n) {
        return pb(t[0] - n[0]) < ob && pb(t[1] - n[1]) < ob
    }
    ...
    function ip(t, n, e, r) {
        ...
        function u(r, i) {
            return pb(r[0] - t) < ob ? i > 0 ? 0 : 3 : pb(r[0] - e) < ob ? i > 0 ? 2 : 1 : pb(r[1] - n) < ob ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
        }
        ...
        return function (u) {
            ...
            function d(o, u) {
                ...
                if (_ && y.push([o, u]), k) g = o, m = u, x = a, k = !1, a && (N.lineStart(), N.point(o, u));
                    ...
                    var c = [b = Math.max(jb, Math.min(Bb, b)), M = Math.max(jb, Math.min(Bb, M))],
                        s = [o = Math.max(jb, Math.min(Bb, o)), u = Math.max(jb, Math.min(Bb, u))];
    ...
    function cp(t, n) {
        t *= hb, n *= hb, zb = t, Pb = bb(n), qb = _b(n), Hb.point = sp
    }
    ...
    function sp(t, n) {
        ...
        var e = bb(n),
            ...
            c = qb * e - Pb * r * o,
            s = Pb * e + qb * r * o;
        Cb.add(vb(Mb(a * a + c * c), s)), zb = t, Pb = e, qb = r
    }

    function fp(t) {
        return Cb ? Cb.reset() : Cb = Gl(), uh(t, Hb), +Cb
    }
    ...
    function dp() {
        ...
        function n() {
            return l(yb(o / y) * y, i, y).map(p).concat(l(yb(s / g) * g, c, g).map(d)).concat(l(yb(r / v) * v, e, v).filter(function (t) {
                return pb(t % y) > ob
            }).map(f)).concat(l(yb(a / _) * _, u, _).filter(function (t) {
                return pb(t % g) > ob
            }).map(h))
        }
        ...
        }, t.extentMajor([[-180, -90 + ob], [180, 90 - ob]]).extentMinor([[-180, -80 - ob], [180, 80 + ob]])
    }
        ...
        var e = t[0] * hb,
            ...
            _ = d ? function (t) {
                var n = bb(t *= d) / v,
                    ...
                    i = e * l + n * p,
                    o = e * a + n * s;
                return [vb(i, r) * lb, vb(o, Mb(r * r + i * i)) * lb]
            } : function () {
                return [e * lb, r * lb]
            };
    ...
    function gp(t, n) {
        Zb.point = mp, Lb = Ub = t, Rb = Db = n
    }

    function mp(t, n) {
        $b.add(Db * t - Ub * n), Ub = t, Db = n
    }
    ...
    function kp(t, n) {
        var e = t - Ib,
            r = n - Yb,
            i = Mb(e * e + r * r);
        iw += i * (Ib + t) / 2, ow += i * (Yb + n) / 2, uw += i, wp(Ib = t, Yb = n)
    }
    ...
    function Ep(t, n) {
        fw.point = Cp, wp(Ob = Ib = t, Fb = Yb = n)
    }
    ...
    function Cp(t, n) {
        var e = t - Ib,
            r = n - Yb,
            i = Mb(e * e + r * r);
        iw += i * (Ib + t) / 2, ow += i * (Yb + n) / 2, uw += i, i = Yb * t - Ib * n, aw += i * (Ib + t), cw += i * (Yb + n), sw += 3 * i, wp(Ib = t, Yb = n)
    }

    function zp(t) {
        function n(n, e) {
            t.moveTo(n + u, e), t.arc(n, e, u, 0, fb)
        }
    ...
    function Rp(t, n) {
        for (var e = n[0], r = n[1], i = [bb(e), -_b(e), 0], o = 0, u = 0, a = 0, c = t.length; a < c; ++a)
            if (f = (s = t[a]).length)
                for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + sb, d = bb(p), v = _b(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
                    var y = s[_],
                        g = y[0],
                        m = y[1] / 2 + sb,
                        x = bb(m),
                        ...
                        k = T > ab,
                        S = d * x;
                    if (lw.add(vb(S * M * bb(T), v * b + S * _b(T))), o += k ? w + M * fb : w, k ^ h >= e ^ g >= e) {
                        var N = vh(ph(l), ph(y));
                        gh(N);
                        var A = vh(i, N);
                        gh(A);
    ...
    function Op(t, n) {
        return ((t = t.x)[0] < 0 ? t[1] - cb - ob : cb - t[1]) - ((n = n.x)[0] < 0 ? n[1] - cb - ob : cb - n[1])
    }
    ...
    function Fp(t) {
        ...
        return {
            ...
            point: function (o, u) {
                var a = o > 0 ? ab : -ab,
                    c = pb(o - e);
                pb(c - ab) < ob ? (t.point(e, r = (r + u) / 2 > 0 ? cb : -cb), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), n = 0) : i !== a && c >= ab && (pb(e - i) < ob && (e -= i * ob), pb(o - a) < ob && (o -= a * ob), r = Ip(e, r, o, u), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), n = 0), t.point(e = o, r = u), i = a
            },
            lineEnd: function () {
                t.lineEnd(), e = r = NaN
            },
    ...
    function Ip(t, n, e, r) {
        var i, o, u = bb(t - e);
        return pb(u) > ob ? db((bb(n) * (o = _b(r)) * bb(e) - bb(r) * (i = _b(n)) * bb(t)) / (i * o * u)) : (n + r) / 2
    }

    function Yp(t, n, e, r) {
        var i;
        if (null == t) i = e * cb, r.point(-ab, i), r.point(0, i), r.point(ab, i), r.point(ab, 0), r.point(ab, -i), r.point(0, -i), r.point(-ab, -i), r.point(-ab, 0), r.point(-ab, i);
        else if (pb(t[0] - n[0]) > ob) {
            var o = t[0] < n[0] ? ab : -ab;
        ...
        function i(t) {
            ...
            return {
                ...
                point: function (l, h) {
                    var p, d = [l, h],
                        v = r(l, h),
                        _ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? ab : -ab), h) : 0;
                    if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (tp(n, p) || tp(d, p)) && (d[0] += ob, d[1] += ob, v = r(d[0], d[1]))), v !== i) f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p;
                    else if (s && n && c ^ v) {
                        var y;
        ...
        function o(t, n, e) {
            ...
            if (!(m < 0)) {
                ...
                var N = T - M,
                    A = pb(N - ab) < ob,
                    E = A || N < ob;
                if (!A && S < k && (w = k, k = S, S = w), E ? A ? k + S > 0 ^ b[1] < (pb(b[0] - M) < ob ? k : S) : k <= b[1] && b[1] <= S : N > ab ^ (M <= b[0] && b[0] <= T)) {
                    var C = yh(_, (-y + x) / g);
        ...
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h,
                    ...
                    M = Mb(x * x + b * b + w * w),
                    T = th(w /= M),
                    k = pb(pb(w) - 1) < ob || pb(o - l) < ob ? (o + l) / 2 : vb(b, x),
                    S = t(k, T),
                    N = S[0],
                    A = S[1],
                    E = N - r,
                    C = A - i,
                    z = g * E - y * C;
                (z * z / m > n || pb((y * E + g * C) / m - .5) > .3 || u * h + a * p + c * d < dw) && (e(r, i, o, u, a, c, N, A, k, x /= M, b /= M, w, v, _), _.point(N, A), e(N, A, k, x, b, w, s, f, l, h, p, d, v, _))
            }
        }
        return function (n) {
            function r(e, r) {
    ...
    function Kp(t) {
        function n(t) {
            return t = f(t[0] * hb, t[1] * hb), [t[0] * _ + a, c - t[1] * _]
        }

        function e(t) {
            return t = f.invert((t[0] - a) / _, (c - t[1]) / _), t && [t[0] * lb, t[1] * lb]
        }
        ...
        return n.stream = function (t) {
                ...
                return arguments.length ? (k = +t ? Bp(T = t * hb, 6 * hb) : (T = null, hw), o()) : T * lb
            }, n.clipExtent = function (t) {
                return arguments.length ? (N = null == t ? (S = l = h = p = null, _p) : ip(S = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == S ? null : [[S, l], [h, p]]
            }, n.scale = function (t) {
                return arguments.length ? (_ = +t, i()) : _
            }, n.translate = function (t) {
                return arguments.length ? (y = +t[0], g = +t[1], i()) : [y, g]
            }, n.center = function (t) {
                return arguments.length ? (m = t[0] % 360 * hb, x = t[1] % 360 * hb, i()) : [m * lb, x * lb]
            }, n.rotate = function (t) {
                return arguments.length ? (b = t[0] % 360 * hb, w = t[1] % 360 * hb, M = t.length > 2 ? t[2] % 360 * hb : 0, i()) : [b * lb, w * lb, M * lb]
            }, n.precision = function (t) {
                return arguments.length ? (E = Zp(r, A = t * t), o()) : Mb(A)
    ...
    function td(t) {
        ...
        return i.parallels = function (t) {
            return arguments.length ? r(n = t[0] * hb, e = t[1] * hb) : [n * lb, e * lb]
        }, i
    }

    function nd(t, n) {
        function e(t, n) {
            var e = Mb(o - 2 * i * bb(n)) / i;
            return [e * bb(t *= i), u - e * _b(t)]
        }
        var r = bb(t),
            i = (r + bb(n)) / 2,
            o = 1 + r * (2 * i - r),
        ...
        return e.invert = function (t, n) {
            var e = u - n;
            return [vb(t, e) / i, th((o - (t * t + e * e) * i * i) / (2 * i))]
        }, e
    }
    ...
    function od() {
        ...
        return t.invert = function (t) {
            ...
            var e = a.scale(),
                u = +n[0],
                l = +n[1];
            return r = a.translate(n).clipExtent([[u - .455 * e, l - .238 * e], [u + .455 * e, l + .238 * e]]).stream(f), i = c.translate([u - .307 * e, l + .201 * e]).clipExtent([[u - .425 * e + ob, l + .12 * e + ob], [u - .214 * e - ob, l + .234 * e - ob]]).stream(f), o = s.translate([u - .205 * e, l + .212 * e]).clipExtent([[u - .214 * e + ob, l + .166 * e + ob], [u - .115 * e - ob, l + .234 * e - ob]]).stream(f), t
    ...
    function fd(t, n) {
        return [t, mb(Tb((cb + n) / 2))]
    }

    function ld() {
        return hd(fd).scale(961 / fb)
    }
    ...
    function dd(t, n) {
        function e(t, n) {
            o > 0 ? n < -cb + ob && (n = -cb + ob) : n > cb - ob && (n = cb - ob);
            var e = o / xb(pd(n), i);
            return [e * bb(i * t), o - e * _b(i * t)]
        }
        var r = _b(t),
            i = t === n ? bb(t) : mb(r / _b(n)) / mb(pd(n) / pd(t)),
            o = r * xb(pd(t), i) / i;
        return i ? (e.invert = function (t, n) {
            var e = o - n,
                r = wb(i) * Mb(t * t + e * e);
            return [vb(t, e) / i, 2 * db(xb(o / r, 1 / i)) - cb]
        }, e) : fd
    }
    ...
    function gd(t, n) {
        function e(t, n) {
            var e = o - n,
                r = i * t;
            return [e * bb(r), o - e * _b(r)]
        }
        var r = _b(t),
            i = t === n ? bb(t) : (r - _b(n)) / (n - t),
            o = r / i + t;
        return pb(i) < ob ? _d : (e.invert = function (t, n) {
            var e = o - n;
            return [vb(t, e) / i, o - wb(i) * Mb(t * t + e * e)]
        }, e)
    }
    ...
    function wd(t, n) {
        return [_b(n) * bb(t), bb(n)]
    }

    function Md() {
        return Qp(wd).scale(249.5).clipAngle(90 + ob)
    }
    ...
    Jl.prototype = {
        ...
        add: function (t) {
            Ql(ib, t, this.t), Ql(this, ib.s, this.s), this.s ? this.t += ib.t : this.s = ib.t
        },
        valueOf: function () {
            return this.s
        }
    };
    var Tx, kx, Sx, Nx, Ax, Ex, Cx, zx, Px, qx, Lx, Rx, Ux, Dx, Ox, Fx, Ix, Yx, Bx, jx, Hx, Xx, Vx, Wx, $x, Zx, Gx, Jx, Qx, Kx, tb, nb, eb, rb, ib = new Jl,
        ob = 1e-6,
        ub = 1e-12,
        ab = Math.PI,
        cb = ab / 2,
        ...
        Nb = {
            ...
            lineEnd: eh,
            polygonStart: function () {
                Tx.reset(), Nb.lineStart = ah, Nb.lineEnd = ch
            },
            polygonEnd: function () {
                var t = +Tx;
                kx.add(t < 0 ? fb + t : t), this.lineStart = this.lineEnd = this.point = eh
            },
            sphere: function () {
                kx.add(fb)
            }
        ...
        Ab = {
            ...
            lineEnd: wh,
            polygonStart: function () {
                Ab.point = Mh, Ab.lineStart = Th, Ab.lineEnd = kh, Fx.reset(), Nb.polygonStart()
            },
            polygonEnd: function () {
                Nb.polygonEnd(), Ab.point = mh, Ab.lineStart = bh, Ab.lineEnd = wh, Tx < 0 ? (zx = -(qx = 180), Px = -(Lx = 90)) : Fx > ob ? Lx = 90 : Fx < -ob && (Px = -90), Yx[0] = zx, Yx[1] = qx
            }
        },
        Eb = {
            sphere: eh,
    ...
    jh.invert = jh;
    var Cb, zb, Pb, qb, Lb, Rb, Ub, Db, Ob, Fb, Ib, Yb, Bb = 1e9,
        jb = -Bb,
        Hb = {
            sphere: eh,
            point: eh,
        ...
        Zb = {
            ...
            polygonEnd: function () {
                Zb.lineStart = Zb.lineEnd = Zb.point = eh, Wb.add(pb($b)), $b.reset()
            },
            result: function () {
                var t = Wb / 2;
                return Wb.reset(), t
    ...
    var yw = ud(function (t) {
        return (t = Kl(t)) && t / bb(t)
    });
    yw.invert = ad(function (t) {
        return t
    }), fd.invert = function (t, n) {
        return [t, 2 * db(gb(n)) - cb]
    }, _d.invert = _d, xd.invert = ad(db), wd.invert = ad(th), Td.invert = ad(function (t) {
        return 2 + db(t)
    }), Sd.invert = function (t, n) {
        return [-n, 2 * db(gb(t)) - cb]
